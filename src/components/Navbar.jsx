            ...
            <nav className='fixed w-full bg-white border border-gray-100 dark:bg-gray-900 font-sans z-10'>
                <div className='max-w-screen flex items-center justify-between px-10 py-2'>
                    <a href='/' className='flex items-center'>
                        <span className='self-center font-semibold whitespace-nowrap dark:text-white md:text-lg lg:text-xl'>NewbieORG</span>
                    </a>
                    <div>
                        <form action='#' id='form' className='invisible flex items-center lg:visible'>
                            <div>
                                <select
                                    defaultValue={'ind'}
                                    name='selectCountry'
                            ...
                            />
                            <button type='submit' name='btn_search' id='btn_search' className='border border-gray-300 rounded-r-full flex items-center px-2 w-full lg:w-[100px] h-[42px] gap-x-2'>
                                ...
                                <ul className='flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700'>
                                    <li>
                                        <div className='flex items-center space-x-4'>
                                            <img src='https://i.pravatar.cc/30' className='rounded-full lg:ml-0 w-{150} h-{150} border border-grey-100' alt={auth.user.name} />
                                            <button
                                        ...
                                        {/* Dropdown menu */}
                                        <div id='dropdownNavbar' className={`${dropdown ? 'hidden' : ''} z-10 fixed font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600`}>
                                            ...
                                            <div className='py-1'>
                                                <button onClick={logout} className='block w-full px-4 py-2 text-start text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white'>
                                                    Sign out
                                                </button>
                                            </div>
                                        </div>
